...
wp_register_script( 'at_good_script', get_template_directory_uri() . '/js/good.js' );
wp_localize_script( 'at_good_script', 'at_product_data', array (
  'images_src_array' => $images_src_array,
));
wp_enqueue_script( 'at_good_script' );
